...
const skillHtml = new Skill({width: 150, height: 150, container: result, percent: 0.65});
const skillCss = new Skill({width: 150, height: 150, container: result, percent: 0.75});
